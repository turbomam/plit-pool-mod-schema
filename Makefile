...
gen-examples:
	cp src/data/examples/valid/DatabaseCollection*.yaml $(EXAMPLEDIR)
...
examples/output: src/split_pool_mod_schema/schema/split_pool_mod_schema.yaml
	mkdir -p $@
...
git-init:
	git init
git-add: .cruft.json
	git add .gitignore .github .cruft.json Makefile LICENSE *.md examples utils about.yaml mkdocs.yml poetry.lock project.Makefile pyproject.toml src/split_pool_mod_schema/schema/*yaml src/*/datamodel/*py src/data src/docs tests src/*/_version.py project/reports/ src/local_schemasheets/
