# Contributing to split-pool-mod-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
split-pool-mod-schema. These guidelines are not strict rules.
...
The split-pool-mod-schema team strives to create a
...
[issues]: https://github.com/turbomam/split-pool-mod-schema/issues/
[pulls]: https://github.com/turbomam/split-pool-mod-schema/pulls/
